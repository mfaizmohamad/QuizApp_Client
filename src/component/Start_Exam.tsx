  ...
  return (
    <DefaultLayout>
      <div className="relative overflow-x-auto rounded-md">
        <p className="text-center text-white mb-2 mt-2">Please choose your preferred assessment and click 'Start' to continue.</p>
        <table className="w-full text-sm text-left rtl:text-right text-white dark:text-gray-400 rounded-md shadow-lg">
          ...
          <tbody>
            <tr className="bg-white bg-opacity-30 border-b dark:bg-gray-800 dark:border-gray-700">
              ...
              <td className="px-15 py-4">Python general exam</td>
              <td className="px-12 py-4">12/02/2024</td>
            ...
            <tr className="bg-white bg-opacity-30 border-b dark:bg-gray-800 dark:border-gray-700">
              ...
              <td className="px-15 py-4">Javascript general exam</td>
              <td className="px-12 py-4">21/04/2025</td>
              <td className="px-2 py-4">
                {" "}
                <button
                  className="bg-green-600 w-[10rem] hover:bg-green-900 text-white font-bold py-2 px-4 rounded"
            ...
            <tr className="bg-white  bg-opacity-30 dark:bg-gray-800">
              ...
              <td className="px-15 py-4">React general exam</td>
              <td className="px-12 py-4">16/07/2024</td>
              <td className="px-2 py-4">
                {" "}
                <button
                  className="bg-green-600 w-[10rem] hover:bg-green-900 text-white font-bold py-2 px-4 rounded"
